...
{
    class ServiceHistoryJobcardViewModel : BaseViewModel
    {
        public ServiceHistoryJobcardViewModel()
        {
            ...
            spare_parts_list = new ObservableCollection<CreateWikitekTicketModel>
            {
                new CreateWikitekTicketModel
                {
                     id = 1,
            ...
            {
                services_list_height = spare_parts_list_height = symotomps_list_height = 56;
            }
            else
            {
                services_list_height = spare_parts_list_height = symotomps_list_height = 66;
            }
